...
# URL of the desired page
url_archive = "https://tviplayer.iol.pt/direto/TVI"
...
# Find all relevant video links
# Adjust the selector to target the a tags within the navCanaisTopo class
video_elements = driver.find_elements(By.CSS_SELECTOR, 'div.navCanaisTopo a')
