...
url_youtube = "https://www.youtube.com/results?search_query=documentario+espa%C3%B1ol&sp=CAI%253D"
...
def limitar_arquivo_m3u(arquivo_original, arquivo_saida, limite_linhas=1200):
    try:
