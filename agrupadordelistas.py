...
url_youtube = "https://www.youtube.com/results?search_query=CBN+&sp=EgJAAQ%253D%253D"
...
def limitar_arquivo_m3u(arquivo_original, arquivo_saida, limite_linhas=400):
    try:
